 ...
 *
 * Common types for the modernization collector overlay (ADR-0004 / COL-001).
...
typedef enum nytp_status {
    ...
    NYTP_ERR_STATE = 2,      /* illegal lifecycle transition (COL-002 expands) */
...
/* Minimal lifecycle for scaffolding; COL-002 freezes the full machine. */
