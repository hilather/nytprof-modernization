 ...
 *
 * Copied from Devel-NYTProf 6.15 pin archive
 *   baseline/6.15/archives/Devel-NYTProf-6.15.tar.gz
 *   member: devel-nytprof-6.15/slowops.h
 * Pin commit: see baseline/6.15/oracle-commit.txt
 * Do not edit baseline/6.15/src as SoT (ADR-0004). Product
 * installs this table on default slowops=2 (6.15 pkg::CORE:op)
 * and on explicit slowops=full / =3. Exclusive remains thin.
 */
