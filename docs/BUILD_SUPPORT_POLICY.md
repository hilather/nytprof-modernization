...
**Status:** PR-G01 docs-landed. `collection_default` remains **v5**. G03a product `-d:NYTProfM` **load**, G03b–G03e emit-MVP, G04 **attach-MVP** (live `-d:NYTProfM` default-calls1 **15/3/15**), and G05 **options/`format=v6` tests** (D1-B fail-closed; D1-A `NYTPROF6`) are landed. G06 **fork/`addpid` MVP** is landed. **Residuals:** full 6.15 opcode/`entersub`, mid-deflate continue-in-child, TEST-018, S2. Identity is **Option B** (`NYTProfM` / `Devel::NYTProfM` **6.15**).  
**Binding:** [DROP_IN_DOD_v0.md](https://github.com/hilather/nytprof-modernization/blob/main/docs/contracts/DROP_IN_DOD_v0.md) D5; design [PRODUCT_COMPLETION_DROP_IN_v0.md](https://github.com/hilather/nytprof-modernization/blob/main/docs/PRODUCT_COMPLETION_DROP_IN_v0.md) (rev-4 identity superseded by [DROP_IN_RPM_COMPLETION_v0.md](https://github.com/hilather/nytprof-modernization/blob/main/docs/DROP_IN_RPM_COMPLETION_v0.md) Option B).
...
[`product_attach_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/product_attach_smoke.sh) is the **G03a load** smoke (real `perl -d:NYTProfM` without `file=`; `phase: S0/S1`; `product_xs_attach: no`). [`g04_v5_parity_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g04_v5_parity_smoke.sh) is the **G04 attach-MVP** smoke (live `-d:NYTProfM` + `file=` + dump/report leaf **15** / mid **3** / edge **15**). [`g05_options_format_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g05_options_format_smoke.sh) is the **G05 options/`format=v6`** smoke (unknown/`dual` fail-closed; D1-B `format=v6` fail-closed; D1-A `NYTPROF6`; v5 15/3/15). [`g06_fork_addpid_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g06_fork_addpid_smoke.sh) is the **G06 fork/`addpid`** smoke (live `fork` + parent/`<file>.<pid>` `NYTProf 5`). [`g07_getopt_compile_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g07_getopt_compile_smoke.sh) is the **PR-7 compile-safe** smoke (`use Getopt::Long` / Exporter / Time::HiRes under `-d:NYTProfM`; `INIT` `$DB::single`; no `heavy_(eval)` / `$VERSION` abort). [`g10_datetime_hints_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g10_datetime_hints_smoke.sh) is the **PR-10 hints-safe attach** smoke (no `CORE::GLOBAL::require` wrap; BHES/Variable::Magic `CvNODEBUG` before `$^P` 0x01; DateTime::Duration). [`g11_nodebug_stash_nogp_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g11_nodebug_stash_nogp_smoke.sh) is the **PR-11 GP-safe stash walk** smoke (`DB::nodebug_stash` must not `GvCV` a GP-less GV). [`g12_memoize_caller_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g12_memoize_caller_smoke.sh) is the **PR-12 Memoize caller** smoke (`memoize('fn')` must not look up `DB::fn`). [`g13_logger_caller_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g13_logger_caller_smoke.sh) is the **PR-13 logger caller** smoke (no `eval` around `&$raw`). [`g14_nested_excl_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g14_nested_excl_smoke.sh) is the **PR-14 nested exclusive** smoke (3-level remainder + `stmts=0`). [`g15_dbstate_timeline_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g15_dbstate_timeline_smoke.sh) is the **PR-15 C `OP_DBSTATE` TIME_LINE** smoke (`$DB::single=0`; not Perl `DB::DB`). [`g16_wrap_enter_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g16_wrap_enter_smoke.sh) is the **PR-16 wrap_push** smoke (default C wrap vs `NYTPROF_WRAP_SLOW=1` control; not DI-03). [`g03b_stmt_emit_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g03b_stmt_emit_smoke.sh) / [`g03c_sub_emit_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g03c_sub_emit_smoke.sh) / [`g03d_meta_emit_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g03d_meta_emit_smoke.sh) / [`g03e_compress_emit_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g03e_compress_emit_smoke.sh) remain emit-MVP. [`product_legacy_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/product_legacy_smoke.sh) is the **I01 P-PRODUCT-LEGACY** smoke (cargo-free prefix install + live attach 15/3/15; honest skip without CC/XS). They are **not** wired into `dual_path_smoke.sh` or `offline_gate.sh` (S2 not claimed). Schema: [`product-attach-smoke-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/product-attach-smoke-mvp-v0.md).

G02 ([`g02_v5_product_link_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/g02_v5_product_link_smoke.sh)) proves the **v5-only archive + load-only XS**. I01 installs that debugger into a prefix without cargo. I02 [`i02_makemaker_native_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/i02_makemaker_native_smoke.sh) wires `NYTPROF_NATIVE=1`/`auto` through shipped `install_native.sh` (`=1` fail-closed without cargo). I03 [`install_product_scripts.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/install_product_scripts.sh) / [`i03_dist_scripts_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/i03_dist_scripts_smoke.sh) installs EngineDispatch + `nytprof-engine` / `nytprofhtml` / `nytprofcsv` into the same product prefix (`make install-product-scripts`; cargo-free `query --json --jsonl` **15/3/15**). J01 [`j01_cpan_hygiene_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/packaging/j01_cpan_hygiene_smoke.sh) makes root `Makefile.PL` emit **`NYTProfM` / `Devel::NYTProfM` 6.15** (`VERSION_FROM` the product `.pm`) and excludes `baseline/` `target/` `prefix/` from `make manifest`. J02 [`RELEASE_NOTES_CPAN_TRIAL_v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/RELEASE_NOTES_CPAN_TRIAL_v0.md) is **notes-ready** attach-preview (**not** uploaded to PAUSE). K01 [`perl-NYTProfM.spec`](https://github.com/hilather/nytprof-modernization/blob/main/packaging/rpm/perl-NYTProfM.spec) is the EL8 **D1-B** module RPM (Option B; no `Provides: perl(Devel::NYTProf)`). K02 [`nytprof-cli.spec`](https://github.com/hilather/nytprof-modernization/blob/main/packaging/rpm/nytprof-cli.spec) is the **tools companion** (ADR-0010 ingest; **Recommends:** `perl-NYTProfM`; **not** drop-in / not signed-pipeline complete). Dual-path remains oracle-primary (`collection_default` stays **v5**; S2 not claimed). P-ORACLE isolation (`legacy_only_smoke.sh` / stock debugger under `baseline/6.15/install`) stays valid forever. The Rocky 8 Docker profile lab ([`rocky8_docker_profile_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/field/rocky8_docker_profile_smoke.sh)) is a **field integration** smoke (honest SKIP without docker). The Rex + DateTime attach lab ([`complex_app_docker_profile_smoke.sh`](https://github.com/hilather/nytprof-modernization/blob/main/scripts/field/complex_app_docker_profile_smoke.sh)) is the same class of field smoke for a real CPAN CLI. Neither is an `offline_gate.sh` step.
