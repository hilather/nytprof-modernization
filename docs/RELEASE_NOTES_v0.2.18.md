...
Unsigned **Rocky 8 / EL8** `perl-NYTProfM` testdrive RPM **6.15-12**. **Not** PAUSE, **not** COPR, **not** GPG-signed, **not** CI-mock certified, **not** GA.
...
- `dnf upgrade` / `rpm -Uvh` to **6.15-12** (there is no published 6.15-11 RPM).
