...
| No full nytprofhtml DOM / REPORT-001..020 | **REPORT-001..020**, BASE-005, **REPORT-HTML-RESIDUAL-INV**, **REPORT-HTML-SHARED-CSS** (MVP `style.css` **done**), **REPORT-HTML-OPTIONAL-FLAME** (opt-in `--flame` **done** — partial vs oracle `flamegraph.pl`) | Native HTML is MVP summary + multi-file site (incl. shared `style.css` / optional flame); not oracle DOM/tablesorter/JS/`flamegraph.pl`/Graphviz | REPORT_SURFACE_CONTRACT residual honesty; **artifact residual matrix:** [`docs/contracts/REPORT_HTML_RESIDUAL_INVENTORY_v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/contracts/REPORT_HTML_RESIDUAL_INVENTORY_v0.md); flame schema [`docs/schemas/html-optional-flame-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/html-optional-flame-mvp-v0.md) |
...
| `REPORT-HTML-OPTIONAL-FLAME` | **done** | opt-in `html --flame` (default off); `all_stacks_by_time.svg` + `.folded`; schema [`docs/schemas/html-optional-flame-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/html-optional-flame-mvp-v0.md); cargo + CLI tests (**15/3/15**). Not `flamegraph.pl` / Graphviz / treemap. **Before COL-007.** |
