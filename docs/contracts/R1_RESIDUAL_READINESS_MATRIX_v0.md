...
| No full nytprofhtml DOM / REPORT-001..020 | **REPORT-001..020**, BASE-005, **REPORT-HTML-RESIDUAL-INV**, **REPORT-HTML-SHARED-CSS** (MVP `style.css` **done** — partial residual vs oracle CSS), **REPORT-HTML-SUBS-EXCL** (MVP `index-subs-excl.html` **done** — partial residual vs oracle DOM) | Native HTML is MVP summary + multi-file site (incl. shared `style.css` / inline CSS policy + exclusive sub index); not oracle DOM/tablesorter/JS/flame/Graphviz | REPORT_SURFACE_CONTRACT **not advertised** list; **artifact residual matrix:** [`docs/contracts/REPORT_HTML_RESIDUAL_INVENTORY_v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/contracts/REPORT_HTML_RESIDUAL_INVENTORY_v0.md); CSS structure [`docs/schemas/html-shared-css-structure-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/html-shared-css-structure-mvp-v0.md); exclusive index [`docs/schemas/html-subs-excl-index-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/html-subs-excl-index-mvp-v0.md) |
