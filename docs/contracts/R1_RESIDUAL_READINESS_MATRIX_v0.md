...
| CLI E5 v6 opt-in surfaces | **CLI-E5-V6-OPT-IN-MVP** **done** (PR-B12) | report/html/csv/folded/callgrind/dump/verify on v6; capability `v6_decode`/`v6_report` true; **`convert`/`merge` false**; **`collection_default: v5`** (no default flip); tests `cli_e5_v6` + capability; schema [`docs/schemas/cli-e5-v6-opt-in-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/cli-e5-v6-opt-in-mvp-v0.md). | **Not** collection default flip (R4); **not** convert/merge; **not** E4 product offline_gate (PR-B12b) |
