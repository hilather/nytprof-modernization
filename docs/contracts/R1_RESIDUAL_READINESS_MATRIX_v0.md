...
| Strict v5↔v6 convert tooling | **TOOL-CONVERT-STRICT-MVP** **done** (PR-C01) | `nytprof-cli convert --to=v5\|v6`; `nytprof_model::convert_*`; capability `convert: yes`; schema [`docs/schemas/convert-strict-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/convert-strict-mvp-v0.md) | No lossy mode; packing/dict v6 out residual; merge/salvage open (PR-C02); oracle wall NV PID refuse |
...
| `TOOL-CONVERT-STRICT-MVP` | **done** (PR-C01) | Strict v5↔v6 convert: `nytprof-cli convert --to=v5\|v6`, `nytprof_model::convert_*`, v5 encoder, absolute v6 EVENT; capability claims `convert: yes` with dual-sink m4 probe. Schema [`docs/schemas/convert-strict-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/convert-strict-mvp-v0.md). Tests: `cargo test -p nytprof-model convert::`, `cargo test -p nytprof-cli --test convert_cli`. **Residuals:** no lossy mode; packing/dict v6 out; merge/salvage (PR-C02); oracle wall NV PID refuse v5→v6. |
