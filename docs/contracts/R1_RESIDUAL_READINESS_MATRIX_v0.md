...
| COL-001..007-codec sink/batch/v5+v6 scaffold only (not product collector) | **COL-001-SINK-MVP** + **COL-002-LIFECYCLE-MVP** + **COL-003-SEQ-MVP** + **COL-004-FAST-PATH-MVP** + **COL-005-BATCH-MVP** + **COL-006-V5-WIRE-MVP** + **COL-007-ABS-MVP** + **COL-007-CODEC-MVP** + **TEST-003-FAKE-CLOCK-MVP** board **done** (scaffold) | Overlay `collector/` semantic sink + lifecycle + gapless seq + **bounded batch + no-alloc stmt fast path** + **real v5 wire writer (zlib)** + **absolute v6 writer (EVENT codecs NONE/ZLIB/ZSTD/LZ4 + multi-chunk + CRC)** + fake-clock/M4 **mini** harness + unit tests + offline_gate step 10. **Residuals:** no live Perl/XS hooks; full M4 oracle corpus residual; COL-015 open; packing/dict/mid-stream switch open (B08); board **COL-007** deferred until E3-C (B09); not dual product sink. Evidence: [`collector/README.md`](https://github.com/hilather/nytprof-modernization/blob/main/collector/README.md), [`docs/schemas/collector-v5-wire-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/collector-v5-wire-mvp-v0.md), [`docs/schemas/collector-v6-absolute-wire-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/collector-v6-absolute-wire-mvp-v0.md), [`docs/schemas/collector-v6-codecs-multi-chunk-crc-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/collector-v6-codecs-multi-chunk-crc-mvp-v0.md), `scripts/packaging/collector_sink_smoke.sh` | R2 runway scaffolding; **not** a claim that collection is modernized in-process
