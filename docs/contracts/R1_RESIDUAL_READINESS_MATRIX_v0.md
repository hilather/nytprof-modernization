...
**Board ID:** `R1-RESIDUAL-MATRIX` (honesty sync: `R1-HONESTY-SYNC`; R2-preview cut: `R2-PREVIEW-READINESS-CUT`)  
...
| **No R2-stable claim** | Fork suite, security/fuzz, P1/P2 cert, platform depth, convert tooling |
...
| **Not claimed** | CPAN upload, performance SLOs, R3/R4 default flips, convert/merge on this branch, COL-008 baseline |
