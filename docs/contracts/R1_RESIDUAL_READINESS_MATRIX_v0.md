...
| `COL-007` | deferred | C v6 writer — implement against accepted ADR-0001/0002 + provisional ID lockfile (FMT freeze **after** E3/E4); not implemented here |
