...
| `COL-007` | deferred | C v6 writer product — ABS+CODEC+PACK scaffold landed; remaining B09 E3-C; FMT freeze **after** E3/E4 |
...
| `DUAL-EQUALITY-READINESS-MVP` | **done** | residual honesty sync for dual-equality readiness. COL-007 still deferred. |
...
| `E3-DUAL-EQUALITY-HARNESS-MVP` | **done** | `dual_equality` E3 harness + stand-in absolute/packing/string-dict/`expect_string_dict`/mid-stream packing tests. Stand-in **not** product dual-equality evidence. C COL-007 producer still deferred. **Before full COL-007.** |
...
| `E4-V5-V6-SEMANTIC-EQUALITY-POLICY-MVP` | **done** | residual honesty for E4 policy. COL-007 deferred. |
