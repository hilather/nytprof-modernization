...
| `DUAL-EQUALITY-READINESS-MVP` | **done** | [`docs/contracts/DUAL_EQUALITY_READINESS_v0.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/contracts/DUAL_EQUALITY_READINESS_v0.md). E1–E5 checklist; ADRs accepted; **E3-EVENT ready with C**; COL-014 dual-sink test/dev harness ready (OQ-4); **E4-v0 model ready**; E3-mixed / full oracle E4 residual; E4 product + E5 ready; COL-008 deferred.  |
