...
| No full MakeMaker XS dual-build CPAN | **BUILD-003** (full) | **BUILD-MAKEMAKER-OPT** + **BUILD-003-DEPTH** partial (facade + prefix dual-install + depth smoke) done; still no XS/collector in root Makefile | Not a complete XS CPAN tarball dual-build; do not treat depth as BUILD-003 complete |
