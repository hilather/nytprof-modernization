# NYTProfM v0.2.9 — EL8 RPM actually ships the HTML v2 visual refresh
...
GitHub Actions workflow [`Release EL8 RPM (test-drive)`](https://github.com/hilather/nytprof-modernization/blob/v0.2.9/.github/workflows/release-el8-rpm.yml) rebuilds the RPM in `rockylinux:8` and attaches it here. Local rebuild: [`scripts/packaging/build_el8_module_rpm.sh`](https://github.com/hilather/nytprof-modernization/blob/v0.2.9/scripts/packaging/build_el8_module_rpm.sh).
...
- HTML v2 design: [`docs/OPERATOR_HTML_V2_DESIGN_v0.md`](https://github.com/hilather/nytprof-modernization/blob/v0.2.9/docs/OPERATOR_HTML_V2_DESIGN_v0.md)
- Shared CSS contract: [`docs/schemas/html-shared-css-structure-mvp-v0.md`](https://github.com/hilather/nytprof-modernization/blob/v0.2.9/docs/schemas/html-shared-css-structure-mvp-v0.md)
- Operator runbook: [`docs/R1_PREVIEW_OPERATOR_RUNBOOK.md`](https://github.com/hilather/nytprof-modernization/blob/v0.2.9/docs/R1_PREVIEW_OPERATOR_RUNBOOK.md)
