# WP-14 - CLI compatibility and user migration
...
- **Objective:** Preserve existing commands, expose engine/format controls, and execute a staged, reversible migration and release rollout.
- **Inputs:** native reports/tools/build capabilities.
- **Required handoff:** wrappers, help/docs, migration/conversion guides, release-level decisions, field-validation process, and rollback instructions.
