...
- Graphviz / `index-subs-excl.html` (other PR slices / map); flame is opt-in — see [html-optional-flame-mvp-v0.md](https://github.com/hilather/nytprof-modernization/blob/main/docs/schemas/html-optional-flame-mvp-v0.md)
