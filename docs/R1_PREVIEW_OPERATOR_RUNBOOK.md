...
| `DI-03` opcode / `entersub` | **in progress, not done** — E0 parse/stamp only (`wrap` / `entersub` / `use_db_sub` 0/1). Default attach is still wrap + C `OP_DBSTATE`. Plan: [DI03_OPCODE_ENTERSUB_ATTACH_v0.md](https://github.com/hilather/nytprof-modernization/blob/main/docs/plan/DI03_OPCODE_ENTERSUB_ATTACH_v0.md) |
