...
| **No full MakeMaker XS CPAN dual-build** | **BUILD-MAKEMAKER-OPT** + **BUILD-003-DEPTH** partial (`install-facade` / `dual-install` / depth smoke) only — still **not** BUILD-003 full XS CPAN. |
