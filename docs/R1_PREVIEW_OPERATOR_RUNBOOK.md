...
| 10 | `./scripts/packaging/collector_sink_smoke.sh` | **COL-001..007 scaffold** — isolation always; `make -C collector test` when CC; honest skip without C. |
