...
| **KD-R2** | Tools RPM (C) is **not** a collection-claim gate. I03 scripts are **not** in the module RPM. | KD-1 / ADR-0010 §6. Operators read `NYTProf 5` via stock `nytprofhtml`, source I03, or C. |
