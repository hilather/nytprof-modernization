...
| [`docs/RELEASE_NOTES_v0.2.17.md`](https://github.com/hilather/nytprof-modernization/blob/main/docs/RELEASE_NOTES_v0.2.17.md) | **v0.2.17** testdrive: default C `OP_ENTERSUB` + `OP_GOTO`, `SUB_CALLERS` aggregated at finish, RPM 6.15-11 |
